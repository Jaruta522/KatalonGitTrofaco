...
for (def rowNum = 1; rowNum <= findTestData('Login').getRowNumbers(); rowNum++) {
    ...
    WebUI.setText(findTestObject('Object_Backend/input_Username is required_username'), findTestData('Login').getValue(1, 
            rowNum //get data from column1
            ))

    //WebUI.setEncryptedText(findTestObject('Object_Backend/input_Username is required_password'), Password)
    WebUI.setText(findTestObject('Object_Backend/input_Username is required_password'), findTestData('Login').getValue(2, 
            rowNum //get data from column2 
            ))
